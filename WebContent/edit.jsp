...
<div id="pre_header" class="visible-lg"></div>
 <div id="header" class="container">
  ...
  <tr>
	...
	<td>
	<input type="text"  id="demo"  name="fname" value=<%=firstname %> readonly="true"><br><br>
	</td>
</tr>
<tr>
	<td>
	...
	<td>
		<input type="text"  id="demo1" name="lname" value=<%=lastname %>  readonly="true"><br> <br>
	</td>
</tr>
<tr>
	<td>
	...
	<td>
		<input type="text"  id="demo2" name="email" value=<%=email %>  readonly="true"><br><br>
	</td>
</tr>
<tr>
	<td>
	...
	<td>
		<input type="text"  id="demo3" name="mobile" value=<%=mobile %>  readonly="true"><br><br>
	</td>
</tr>
...
function myFunction() {
    ...
    document.getElementById("demo1").readOnly = false;
    document.getElementById("demo2").readOnly = false;
    document.getElementById("demo3").readOnly = false;
}
</script>
  </td>
  </tr>
