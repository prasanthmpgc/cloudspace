...
<form action="emailservlet" method="post">
        <table border="0" width="35%" align="center">
            ...
            <tr>
                <td width="50%"><strong>Recipient address</strong></td>
                <td><input type="text" name="email" value="mpgc922@gmail.com" size="50"/></td>
            </tr>
            <tr>
            	<td><strong>EmployeeID</strong></td>
            	<td><input type="text" name="empid"  size="50"/></td>
            </tr>
            <tr>
